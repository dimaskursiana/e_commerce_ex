...
namespace PAYROLLPORTAL.Controllers
{
    public class ContactSupportController : Controller
    {
        ...
        public JsonResult GetListContactSupportTable(Global_Customer_Notice globalPayrollPortal)
        {
            try
            {
                if (ModelValidate.ValidationSupport(globalPayrollPortal, GlobalVariable.CONST_LANG_EN, GlobalVariable.CONST_CREATE, out errMessage, "RequestContactUs"))
                {
                    globalPayrollPortal.customerNoticeModels = new tbl_Customer_Notice();
                    globalPayrollPortal.customerNoticeModels.id = Guid.NewGuid();
                    globalPayrollPortal.customerNoticeModels.Type_Form = "Contact Us";
                    ...
                    globalPayrollPortal.customerNoticeModels.Message = globalPayrollPortal.Message;
                    globalPayrollPortal.customerNoticeModels.Create_Date = DateTime.Now;
                    globalPayrollPortal.customerNoticeModels.Pricing = globalPayrollPortal.Pricing;
            ...
            {
                UIException.LogException(ex, "ContactSupport.Index");
