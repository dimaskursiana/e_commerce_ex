...
namespace APP_MODEL.ModelData
{
    ...
    public partial class tbl_Exchange_Rate_1
    {
        public tbl_Exchange_Rate_1()
        {
            this.tbl_Exchange_Rate_Details_1 = new HashSet<tbl_Exchange_Rate_Details_1>();
        }
        ...
        public virtual ICollection<tbl_Exchange_Rate_Details_1> tbl_Exchange_Rate_Details_1 { get; set; }
    }
}
