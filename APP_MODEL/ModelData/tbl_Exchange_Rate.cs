...
namespace APP_MODEL.ModelData
{
    ...
    public partial class tbl_Exchange_Rate
    {
        public tbl_Exchange_Rate()
        {
            this.tbl_Exchange_Rate_Details = new HashSet<tbl_Exchange_Rate_Details>();
        }
        ...
        public virtual ICollection<tbl_Exchange_Rate_Details> tbl_Exchange_Rate_Details { get; set; }
