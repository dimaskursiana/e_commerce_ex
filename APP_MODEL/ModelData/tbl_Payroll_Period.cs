...
namespace APP_MODEL.ModelData
{
    ...
    public partial class tbl_Payroll_Period
    {
        public tbl_Payroll_Period()
        {
            this.tbl_Payroll_Period_Detail = new HashSet<tbl_Payroll_Period_Detail>();
        }
        ...
        public virtual ICollection<tbl_Payroll_Period_Detail> tbl_Payroll_Period_Detail { get; set; }
